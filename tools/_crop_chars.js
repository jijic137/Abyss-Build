/* 批量去水印：把 assets/art/chars/{id}/Pixel_art_*.png 裁掉底部 110px 写成 assets/art/chars/{id}.png */
'use strict';
const fs = require('fs');
...
(async () => {
  ...
  for (const id of IDS) {
    const dir = path.join('assets', 'art', 'chars', id);
    ...
    fs.writeFileSync(path.join('assets', 'art', 'chars', id + '.png'), buf);
